...
void AVehicleTemplatePawn::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("LookUp", this, &AVehicleTemplatePawn::LookUp);
	PlayerInputComponent->BindAxis("LookRight", this, &AVehicleTemplatePawn::LookRight);
...
//Implementing a LookUp Function to Look Around the Car
void AVehicleTemplatePawn::LookUp(float Val)
{
	if (Val != 0.f)
	{
...
//Implementing a LookRight Function to Look Around the Car
void AVehicleTemplatePawn::LookRight(float Val)
{
	if (Val != 0.f)
	{
